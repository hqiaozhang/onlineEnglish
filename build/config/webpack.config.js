 ...
 * @Last Modified time: 2018-04-08 14:11:55
  */
 ...
 webpackConfig.plugins = [
  ...
  new AddAssetHtmlPlugin({
    ...
    outputPath: 'scripts',
    publicPath: `http://${project.server_host}:${project.server_port}${project.project_name}/scripts`
   })
 ]
 ...
 if (__DEV__) {
   ...
   webpackConfig.plugins.push(
     ...
     new AddAssetHtmlPlugin({
      ...
      outputPath: 'styles',
      publicPath: `http://${project.server_host}:${project.server_port}${project.project_name}/styles`,
    })
   )
 } else if (__PROD__) {
