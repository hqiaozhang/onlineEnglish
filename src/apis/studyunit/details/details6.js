export default {
  ...
  mock: {
    ...
    result: {
      unit6_2: {
        u2_301: {
          stepName: '阅读处方标签 Reading prescription labels',
          stepTypeId: 2,
          stepTypeName: '阅读',
          grammarVideo: {
            scripts: []
